...
val ZenifySecondary = Color(0xFF594C8C)
val ZenifyTertiary = Color(0xFF3B2A5C)
...
val TrackGradient = Brush.radialGradient(
    colors = listOf(
        ...
        Color(0xFF1F1C2C)   // Dark background blend
    )
)

val blackToNeveBlue = Brush.verticalGradient(
    colors = listOf(
        Color(0xFF000000),
        Color(0xFF060612),
        Color(0xFF0C0C22),
...
val blackToDreamWave = Brush.verticalGradient(
    colors = listOf(
        Color(0xFF000000),
        Color(0xFF0B0C13),
        Color(0xFF141627),
        ...
        Color(0xFF9D9DFF),
        Color(0xFFAEAEFF),
        Color(0xFFC0BEFF), // Soft gray instead of white
    )
)
